...
public class Editorial {
    ...
    class Solution {
        ...
        public int colorTheGrid(int m, int n) {
            ...
            // Preprocess all (mask1, mask2) binary tuples, satisfying mask1 and mask2 When
            // adjacent rows, the colors of the two cells in the same column are different
